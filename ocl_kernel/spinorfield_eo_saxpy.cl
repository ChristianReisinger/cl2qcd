...
__kernel void saxpy_eoprec_real_vec(__global const spinorStorageType* const x,
                                    __global const spinorStorageType* const y, __global const hmc_float* alpha,
                                    const int index_alpha, __global spinorStorageType* const out)
{
...
// alpha*x +y
// CC: defined with a plus!!!
__kernel void saxpy_eoprec_real(__global const spinorStorageType* const x, __global const spinorStorageType* const y,
                                __global const hmc_float* const alpha, __global spinorStorageType* const out)
{
    int id          = get_global_id(0);
    int global_size = get_global_size(0);
