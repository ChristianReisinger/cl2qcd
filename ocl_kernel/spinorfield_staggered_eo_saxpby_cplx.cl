...
__kernel void saxpby_cplx_arg_staggered_eoprec(__global const staggeredStorageType* const x,
                                               __global const staggeredStorageType* const y, const hmc_float alpha_re,
                                               const hmc_float alpha_im, const hmc_float beta_re,
                                               const hmc_float beta_im, __global staggeredStorageType* const out)
{
    const int id          = get_global_id(0);
    const int global_size = get_global_size(0);
