...
void hardware::lattices::Spinorfield_eo::import(const spinor* const host) const
{
    ...
    if (buffers.size() == 1) {
        ...
        // buffer->load( &host[tmp2.getSecondHaloPartIndex_source()], tmp2.getHaloPartSize(), tmp2.getMainPartSize() +
        // tmp2.getHaloPartSize());
        //
        //}
        // If desired at this point the import for multi devices should be implemented. Probably the above code should
        // do it but it has to be checked.
