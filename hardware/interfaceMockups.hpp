    ...
    namespace code {
        class OpenClKernelParametersMockup : public OpenClKernelParametersInterface {
          public:
            ...
            virtual double getCsw() const override { return 1.; }
            ...
            virtual bool getUseOnlyClover() const override { return false; }
        ...
        class OpenClKernelParametersMockupForCloverEvenOdd final : public OpenClKernelParametersMockupForSpinorTests {
          public:
            ...
            virtual double getCsw() const override { return csw; }
            virtual double getKappa() const override { return kappa; }
