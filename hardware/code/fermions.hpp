    ...
    namespace code {
        ...
        class Fermions : public hardware::code::Opencl_Module {
          public:
            ...
            //    clover_eo
            //        explicit
            void clover_eo_device(const hardware::buffers::Spinor* in, const hardware::buffers::Spinor* out,
                                  const hardware::buffers::SU3* gf, int evenodd, hmc_float kappa = ARG_DEF,
                                  hmc_float csw = ARG_DEF) const;
            void clover_eo_inverse_device(const hardware::buffers::Spinor* in, const hardware::buffers::Spinor* out,
                                          const hardware::buffers::SU3* gf, int evenodd, hmc_float kappa = ARG_DEF,
                                          hmc_float csw = ARG_DEF) const;
            /**
