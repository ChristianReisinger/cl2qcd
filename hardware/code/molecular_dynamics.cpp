...
void hardware::code::Molecular_Dynamics::fill_kernels()
{
    ...
    if (kernelParameters->getUseEo() == true) {
        ...
        fermion_force_clover1_eo_0 = createKernel("fermion_force_clover1_eo_0")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover1_eo.cl";
        fermion_force_clover1_eo_1 = createKernel("fermion_force_clover1_eo_1")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover1_eo.cl";
        fermion_force_clover1_eo_2 = createKernel("fermion_force_clover1_eo_2")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover1_eo.cl";
        fermion_force_clover1_eo_3 = createKernel("fermion_force_clover1_eo_3")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover1_eo.cl";
        fermion_force_clover2_eo_0 = createKernel("fermion_force_clover2_eo_0")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover2_eo.cl";
        fermion_force_clover2_eo_1 = createKernel("fermion_force_clover2_eo_1")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover2_eo.cl";
        fermion_force_clover2_eo_2 = createKernel("fermion_force_clover2_eo_2")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover2_eo.cl";
        fermion_force_clover2_eo_3 = createKernel("fermion_force_clover2_eo_3")
                                     << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl"
                                     << "fermionmatrix.cl"
                                     << "operations_matrix6x6.cl"
                                     << "force_fermion_clover2_eo.cl";
...
void hardware::code::Molecular_Dynamics::fermion_force_clover1_eo_device(
    const hardware::buffers::Spinor* Y, const hardware::buffers::Spinor* X, const hardware::buffers::SU3* gf,
    const hardware::buffers::Gaugemomentum* out, int evenodd, hmc_float kappa, hmc_float csw) const
{
    using namespace hardware::buffers;
    // get kappa
    hmc_float kappa_tmp;
...
void hardware::code::Molecular_Dynamics::fermion_force_clover2_eo_device(
    const hardware::buffers::SU3* gf, const hardware::buffers::matrix6x6* C, const hardware::buffers::matrix6x6* D,
    const hardware::buffers::Gaugemomentum* out, int evenodd, hmc_float kappa, hmc_float csw) const
{
    using namespace hardware::buffers;
...
hardware::code::Molecular_Dynamics::Molecular_Dynamics(
    ...
    , fermion_force_clover1_eo_0(0)
    , fermion_force_clover1_eo_1(0)
    , fermion_force_clover1_eo_2(0)
    , fermion_force_clover1_eo_3(0)
    , fermion_force_clover2_eo_0(0)
    , fermion_force_clover2_eo_1(0)
    , fermion_force_clover2_eo_2(0)
    , fermion_force_clover2_eo_3(0)
