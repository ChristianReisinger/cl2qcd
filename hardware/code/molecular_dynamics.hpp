        ...
        class Molecular_Dynamics : public Opencl_Module {
          public:
            ...
            void fermion_force_eo_device(const hardware::buffers::Spinor* Y, const hardware::buffers::Spinor* X,
                                         ...
                                         int evenodd, hmc_float kappa = ARG_DEF) const;
            void fermion_force_clover1_eo_device(const hardware::buffers::Spinor* Y, const hardware::buffers::Spinor* X,
                                                 const hardware::buffers::SU3* gf,
                                                 const hardware::buffers::Gaugemomentum* out, int evenodd,
                                                 hmc_float kappa = ARG_DEF, hmc_float csw = ARG_DEF) const;
            void fermion_force_clover2_eo_device(const hardware::buffers::SU3* gf,
                                                 const hardware::buffers::matrix6x6* C,
                                                 const hardware::buffers::matrix6x6* D,
                                                 const hardware::buffers::Gaugemomentum* out, int evenodd,
                                                 hmc_float kappa = ARG_DEF, hmc_float csw = ARG_DEF) const;
