    ...
    namespace code {
        ...
        class Spinors : public Opencl_Module {
          public:
            ...
            void set_float_to_scalar_product_real_device(const hardware::buffers::Plain<spinor>* a,
                                                         const hardware::buffers::Plain<spinor>* b,
            ...
            void set_complex_to_scalar_product_eoprec_device(const hardware::buffers::Spinor* a,
                                                             ...
                                                             const hardware::buffers::Plain<hmc_complex>* out) const;
            void set_float_to_scalar_product_real_eoprec_device(const hardware::buffers::Spinor* a,
                                                                const hardware::buffers::Spinor* b,
                                                                const hardware::buffers::Plain<hmc_float>* out) const;
            ...
            void saxpy_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
                              ...
                              const hardware::buffers::Plain<spinor>* out) const;
            void saxpy_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
                              const hmc_float alpha, const hardware::buffers::Plain<spinor>* out) const;
            void saxpy_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
            ...
            void saxpby_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<spinor>* y,
            ...
            void sax_device(const hardware::buffers::Plain<spinor>* x,
                            const hardware::buffers::Plain<hmc_complex>* alpha,
                            const hardware::buffers::Plain<spinor>* out) const;
            void sax_device(const hardware::buffers::Plain<spinor>* x, const hardware::buffers::Plain<hmc_float>* alpha,
                            const int index_alpha, const hardware::buffers::Plain<spinor>* out) const;
            ...
            void saxpy_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
                                     const hmc_float alpha, const hardware::buffers::Spinor* out) const;
            void saxpby_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
                                      const hmc_complex alpha, const hmc_complex beta,
                                      const hardware::buffers::Spinor* out) const;
            void saxpby_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Spinor* y,
                                      const hardware::buffers::Plain<hmc_float>* alpha,
                                      const hardware::buffers::Plain<hmc_float>* beta, const int index_alpha,
                                      const int index_beta, const hardware::buffers::Spinor* out) const;
            void sax_eoprec_device(const hardware::buffers::Spinor* x,
                                   const hardware::buffers::Plain<hmc_complex>* alpha,
                                   const hardware::buffers::Spinor* out) const;
            void sax_eoprec_device(const hardware::buffers::Spinor* x, const hardware::buffers::Plain<hmc_float>* alpha,
