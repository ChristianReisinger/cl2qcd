...
struct Matrix6x6FieldTestParameters : public virtual TestParameters {
    ...
    Matrix6x6FieldTestParameters(const LatticeExtents latticeExtentsIn, const GaugefieldFillType fillTypeIn,
                                 const hmc_float kappaIn, const hmc_float cswIn)
...
struct Matrix6x6FieldTester : public KernelTester {
    Matrix6x6FieldTester(std::string kernelName, const ParameterCollection parameterCollection,
                         const Matrix6x6FieldTestParameters testParameters, const ReferenceValues rV)
...
struct Matrix6x6FieldTesterWithSumAsKernelResult : public Matrix6x6FieldTester {
    Matrix6x6FieldTesterWithSumAsKernelResult(const std::string kernelName,
                                              const ParameterCollection parameterCollection,
                                              const Matrix6x6FieldTestParameters testParameters,
