...
const ReferenceValues calculateReferenceValues_FFermionClover1EvenOdd(const int latticeVolume,
                                                                      const GaugeMomentumFilltype gmFillType,
                                                                      const SpinorFillType sfFillType,
                                                                      const CloverParameters cloverParameters)
{
...
const ReferenceValues
calculateReferenceValues_FFermionClover2EvenOdd(const int latticeVolume, const GaugeMomentumFilltype gmFillType,
                                                const Matrix6x6FieldFillType mat6x6FillType,
                                                const CloverParameters cloverParameters, const bool evenOrOdd)
{
    if (cloverParameters.csw == nonTrivialParameter && cloverParameters.kappa == nonTrivialParameter) {
        if (gmFillType == GaugeMomentumFilltype::One) {
...
struct MolecularDynamicsTestParameters : public GaugemomentumTestParameters {
    MolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType fillTypeIn,
        ...
        , matrix6x6FieldFillType(Matrix6x6FieldFillType::unity)
        , massParameters(1.)
        , cloverParameters(1., 1.)
    {
    }
    ...
    MolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                    GaugeMomentumFilltype gmFillTypeIn, SpinorFillType sfFillTypeIn,
                                    CloverParameters cloverParametersIn)
        : GaugemomentumTestParameters(latticeExtendsIn, gmFillTypeIn)
        , gaugeFillType(gfFillTypeIn)
        , gmFillType(gmFillTypeIn)
        , spinorFillType(sfFillTypeIn)
    ...
    MolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                    GaugeMomentumFilltype gmFillTypeIn, Matrix6x6FieldFillType mat6x6FillTypeIn,
                                    CloverParameters cloverParametersIn)
        : GaugemomentumTestParameters(latticeExtendsIn, gmFillTypeIn)
        , gaugeFillType(gfFillTypeIn)
        , gmFillType(gmFillTypeIn)
        , spinorFillType(SpinorFillType::zero)
        , matrix6x6FieldFillType(mat6x6FillTypeIn)
        , massParameters(1.)
        , cloverParameters(cloverParametersIn)
    {
    }
...
struct CloverEvenOddMolecularDynamicsTestParameters : public MolecularDynamicsTestParameters {
    CloverEvenOddMolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                                 GaugeMomentumFilltype gmFillTypeIn, SpinorFillType sfFillTypeIn,
                                                 CloverParameters cloverParametersIn, const bool evenOrOddIn)
        : MolecularDynamicsTestParameters(latticeExtendsIn, gfFillTypeIn, gmFillTypeIn, sfFillTypeIn,
                                          cloverParametersIn)
        , evenOrOdd(evenOrOddIn)
    {
    }
    CloverEvenOddMolecularDynamicsTestParameters(const LatticeExtents latticeExtendsIn, GaugefieldFillType gfFillTypeIn,
                                                 ...
                                                 Matrix6x6FieldFillType mat6x6FillTypeIn,
                                                 CloverParameters cloverParametersIn, const bool evenOrOddIn)
        : MolecularDynamicsTestParameters(latticeExtendsIn, gfFillTypeIn, gmFillTypeIn, mat6x6FillTypeIn,
                                          cloverParametersIn)
        , evenOrOdd(evenOrOddIn)
    {
    }
...
struct FFermionClover1EvenOddTester : public MolecularDynamicsTester {
    FFermionClover1EvenOddTester(const ParameterCollection pC, const CloverEvenOddMolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_fermion_clover1_eo", pC,
                                  calculateReferenceValues_FFermionClover1EvenOdd(tP.latticeExtents.getLatticeVolume(),
                                                                                  tP.gmFillType, tP.spinorFillType,
                                                                                  tP.cloverParameters),
                                  tP)
    {
        EvenOddSpinorfieldCreator sf(tP.latticeExtents);
        ...
        molecularDynamicsCode->fermion_force_clover1_eo_device(&in1, &in2, gaugefieldBuffer, gaugemomentumBuffer,
                                                               tP.evenOrOdd, tP.cloverParameters.kappa,
                                                               tP.cloverParameters.csw);
        MolecularDynamicsTester::calcSquarenormAndStoreAsKernelResult(gaugemomentumBuffer);
    }
};
...
struct FFermionClover2EvenOddTester : public MolecularDynamicsTester {
    FFermionClover2EvenOddTester(const ParameterCollection pC, const CloverEvenOddMolecularDynamicsTestParameters tP)
        : MolecularDynamicsTester("f_fermion_clover2_eo", pC,
                                  calculateReferenceValues_FFermionClover2EvenOdd(tP.latticeExtents.getLatticeVolume(),
                                                                                  tP.gmFillType,
                                                                                  tP.matrix6x6FieldFillType,
                                                                                  tP.cloverParameters, tP.evenOrOdd),
                                  tP)
    {
        Matrix6x6FieldCreator matrix6x6(tP.latticeExtents);
        const hardware::buffers::matrix6x6* matrix6x6FieldBuffer = new hardware::buffers::matrix6x6(tP.latticeExtents,
                                                                                                    this->device);
        ...
        molecularDynamicsCode->fermion_force_clover2_eo_device(gaugefieldBuffer, matrix6x6FieldBuffer,
                                                               matrix6x6FieldBuffer, gaugemomentumBuffer, tP.evenOrOdd,
                                                               tP.cloverParameters.kappa, tP.cloverParameters.csw);
        MolecularDynamicsTester::calcSquarenormAndStoreAsKernelResult(gaugemomentumBuffer);
    }
};
...
template<class TesterClass>
void callTest(const LatticeExtents lE, GaugefieldFillType gfFillType, GaugeMomentumFilltype gmFillType,
              SpinorFillType sfFillType, const bool evenOrOdd, CloverParameters cloverParameters)
{
    CloverEvenOddMolecularDynamicsTestParameters parametersForThisTest(lE, gfFillType, gmFillType, sfFillType,
                                                                       cloverParameters, evenOrOdd);
    hardware::HardwareParametersMockup hardwareParameters(lE, true);
    hardware::code::OpenClKernelParametersMockupForCloverEvenOdd kernelParameters(parametersForThisTest.ns,
                                                                                  parametersForThisTest.nt,
                                                                                  cloverParameters.kappa,
                                                                                  cloverParameters.csw);
    ParameterCollection parameterCollection{hardwareParameters, kernelParameters};
    TesterClass(parameterCollection, parametersForThisTest);
}
...
template<class TesterClass>
void callTest(const LatticeExtents lE, GaugefieldFillType gfFillType, GaugeMomentumFilltype gmFillType,
              Matrix6x6FieldFillType mat6x6FillType, const bool evenOrOdd, CloverParameters cloverParameters)
{
    CloverEvenOddMolecularDynamicsTestParameters parametersForThisTest(lE, gfFillType, gmFillType, mat6x6FillType,
                                                                       cloverParameters, evenOrOdd);
    hardware::HardwareParametersMockup hardwareParameters(lE, true);
    hardware::code::OpenClKernelParametersMockupForCloverEvenOdd kernelParameters(parametersForThisTest.ns,
                                                                                  parametersForThisTest.nt,
...
void testEvenOddClover1FermionForce(const LatticeExtents lE, GaugefieldFillType fillType,
...
void testEvenOddClover2FermionForce(const LatticeExtents lE, GaugefieldFillType fillType,
                                    GaugeMomentumFilltype gmFillType, Matrix6x6FieldFillType mat6x6FillType,
                                    const bool evenOrOdd, CloverParameters cloverParameters)
{
...
BOOST_AUTO_TEST_SUITE(F_FERMION_CLOVER2_EO)
    ...
    BOOST_AUTO_TEST_CASE(F_FERMION_CLOVER2_EO_1)
    {
        testEvenOddClover2FermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::ascendingInTDirNonTrivialInSpatial,
                                       GaugeMomentumFilltype::One, Matrix6x6FieldFillType::unity, EVEN,
                                       CloverParameters{nonTrivialParameter, nonTrivialParameter});
    }
    BOOST_AUTO_TEST_CASE(F_FERMION_CLOVER2_EO_2)
    {
        testEvenOddClover2FermionForce(LatticeExtents{ns4, nt4}, GaugefieldFillType::ascendingInTDirNonTrivialInSpatial,
                                       GaugeMomentumFilltype::Ascending, Matrix6x6FieldFillType::unity, ODD,
                                       CloverParameters{nonTrivialParameter, nonTrivialParameter});
    }
