...
const ReferenceValues
calculateReferenceValues_scalarProductReal(const int latticeVolume, const SpinorFillTypes fillTypesIn)
{
    if (fillTypesIn.at(0) == SpinorFillType::one and fillTypesIn.at(1) == SpinorFillType::one) {
        return ReferenceValues{latticeVolume * 12., 0.};
    } else if (fillTypesIn.at(0) == SpinorFillType::one and fillTypesIn.at(1) == SpinorFillType::ascendingComplex) {
...
{
    return ReferenceValues{
        calculateReferenceValues_sax(latticeVolume, ComplexNumbers{{1. + alphaIn.at(0).re, 0.}}).at(0)};
}
...
const ReferenceValues calculateReferenceValue_saxpby(const int latticeVolume, const ComplexNumbers alphaIn)
{
    return ReferenceValues{
        calculateReferenceValues_sax(latticeVolume, ComplexNumbers{{alphaIn.at(0).re + alphaIn.at(1).re,
            ...
            .at(0)};
    //	return ReferenceValues{calculateReferenceValues_sax(latticeVolume, ComplexNumbers {{alphaIn.at(0).re +
    // alphaIn.at(1).re,  0.}}).at(0)};
}
...
struct ScalarProductRealTester : public NonEvenOddLinearCombinationTester {
    ScalarProductRealTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTester("scalar_product_real_part", parameterCollection, testParameters,
                                            calculateReferenceValues_scalarProductReal(calculateSpinorfieldSize(
                                                                                           testParameters
                                                                                               .latticeExtents),
                                                                                       testParameters.fillTypes))
    {
...
struct ScalarProductRealEvenOddTester : public EvenOddLinearCombinationTester {
    ScalarProductRealEvenOddTester(const ParameterCollection& parameterCollection,
                                   const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTester("scalar_product_real_part_eoprec", parameterCollection, testParameters,
                                         calculateReferenceValues_scalarProductReal(calculateEvenOddSpinorfieldSize(
                                                                                        testParameters.latticeExtents),
                                                                                    testParameters.fillTypes))
    {
        hardware::buffers::Plain<hmc_float> sqnorm(1, device);
...
struct SaxRealVecEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxRealVecEvenOddTester(const ParameterCollection& parameterCollection,
                            const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_real_vec_eoprec", parameterCollection,
                                                                     testParameters, calculateReferenceValues_sax)
    {
...
struct SaxRealVecTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxRealVecTester(const ParameterCollection& parameterCollection,
                     const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("sax_real_vec", parameterCollection,
                                                                        testParameters, calculateReferenceValues_sax)
    {
        hardware::buffers::Plain<hmc_float> alpha_real_vec(5, device);
        std::vector<hmc_float> alpha_host_real_vec(5, testParameters.complexCoefficients.at(0).re);
...
struct SaxpyRealTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyRealTester(const ParameterCollection& parameterCollection,
                    const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_real", parameterCollection,
                                                                        testParameters,
                                                                        calculateReferenceValues_saxpy_real)
    {
...
struct SaxpyRealArgTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyRealArgTester(const ParameterCollection& parameterCollection,
                       const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_real_arg", parameterCollection,
                                                                        testParameters,
                                                                        calculateReferenceValues_saxpy_real)
    {
        code->saxpy_device(spinorfields.at(0), spinorfields.at(1), testParameters.complexCoefficients.at(0).re,
                           getOutSpinor());
    }
};

struct SaxpyRealVecTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyRealVecTester(const ParameterCollection& parameterCollection,
                       const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_real_vec", parameterCollection,
                                                                        testParameters,
                                                                        calculateReferenceValues_saxpy_real)
    {
        hardware::buffers::Plain<hmc_float> alpha_real_vec(5, device);
...
struct SaxpbyRealVecNonEvenOddTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyRealVecNonEvenOddTester(const ParameterCollection parameterCollection,
                                  const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_real_vec", parameterCollection,
                                                                        testParameters, calculateReferenceValue_saxpby)
    {
        hardware::buffers::Plain<hmc_float> alpha_real_vec(5, device);
        std::vector<hmc_float> alpha_host_real_vec(5, testParameters.complexCoefficients.at(0).re);
        const int index_alpha = 3;
        ...
        code->saxpby_device(spinorfields.at(0), spinorfields.at(1), &alpha_real_vec, &beta_real_vec, index_alpha,
...
struct SaxpbyArgComplexTester : public NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyArgComplexTester(const ParameterCollection& parameterCollection,
                           const LinearCombinationTestParameters testParameters)
        : NonEvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_cplx_arg", parameterCollection,
                                                                        testParameters, calculateReferenceValue_saxpby)
    {
        code->saxpby_device(spinorfields.at(0), spinorfields.at(1), testParameters.complexCoefficients.at(0),
...
struct SaxpyRealEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyRealEvenOddTester(const ParameterCollection& parameterCollection,
                           const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_eoprec_real", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy_real)
    {
        hardware::buffers::Plain<hmc_float> alpha_real_vec(1, device);
...
struct SaxpyRealVecEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyRealVecEvenOddTester(const ParameterCollection& parameterCollection,
                              const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_eoprec_real_vec", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy_real)
    {
        hardware::buffers::Plain<hmc_float> alpha_real_vec(5, device);
...
struct SaxpyRealArgEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpyRealArgEvenOddTester(const ParameterCollection& parameterCollection,
                              const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpy_eoprec_real_arg", parameterCollection,
                                                                     testParameters,
                                                                     calculateReferenceValues_saxpy_real)
    {
        code->saxpy_eoprec_device(spinorfields.at(0), spinorfields.at(1), testParameters.complexCoefficients.at(0).re,
                                  getOutSpinor());
    }
};

struct SaxpbyEvenOddArgComplexTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyEvenOddArgComplexTester(const ParameterCollection& parameterCollection,
                                  const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_eoprec_cplx_arg", parameterCollection,
                                                                     testParameters, calculateReferenceValue_saxpby)
    {
...
struct SaxpbyRealVecEvenOddTester : public EvenOddLinearCombinationTesterWithSquarenormAsKernelResult {
    SaxpbyRealVecEvenOddTester(const ParameterCollection parameterCollection,
                               const LinearCombinationTestParameters testParameters)
        : EvenOddLinearCombinationTesterWithSquarenormAsKernelResult("saxpby_eoprec_real_vec", parameterCollection,
                                                                     testParameters, calculateReferenceValue_saxpby)
    {
        hardware::buffers::Plain<hmc_float> alpha_real_vec(5, device);
        std::vector<hmc_float> alpha_host_real_vec(5, testParameters.complexCoefficients.at(0).re);
...
BOOST_AUTO_TEST_SUITE(SCALAR_PRODUCT)
    ...
    {
        testNonEvenOddScalarProductReal(LatticeExtents{ns4, nt4},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_2)
    {
        testNonEvenOddScalarProductReal(LatticeExtents{ns4, nt4}, SpinorFillTypes{SpinorFillType::ascendingComplex,
                                                                                  SpinorFillType::ascendingComplex});
    }
    ...
    {
        testNonEvenOddScalarProductReal(LatticeExtents{ns8, nt12},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_REDUCTION_2)
    {
        testNonEvenOddScalarProductReal(LatticeExtents{ns8, nt4},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }

    BOOST_AUTO_TEST_CASE(SCALAR_PRODUCT_REAL_REDUCTION_3)
    {
        testNonEvenOddScalarProductReal(LatticeExtents{ns8, nt16},
                                        SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }
...
BOOST_AUTO_TEST_SUITE(SCALAR_PRODUCT_EO)
    ...
    {
        testEvenOddScalarProductReal(LatticeExtents{ns4, nt4},
                                     SpinorFillTypes{SpinorFillType::one, SpinorFillType::one});
    }
...
BOOST_AUTO_TEST_SUITE(SAXPY)
    ...
    BOOST_AUTO_TEST_CASE(SAXPY_9) { testNonEvenOddSaxpyReal(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_10) { testNonEvenOddSaxpyReal(LatticeExtents{ns8, nt4}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_11) { testNonEvenOddSaxpyReal(LatticeExtents{ns4, nt8}, ComplexNumbers{{-1., 0.}}); }
...
BOOST_AUTO_TEST_SUITE(SAXPY_EO)
    ...
    BOOST_AUTO_TEST_CASE(SAXPY_EO_9) { testEvenOddSaxpyReal(LatticeExtents{ns4, nt4}, ComplexNumbers{{0., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_10) { testEvenOddSaxpyReal(LatticeExtents{ns8, nt4}, ComplexNumbers{{1., 0.}}); }

    BOOST_AUTO_TEST_CASE(SAXPY_EO_11) { testEvenOddSaxpyReal(LatticeExtents{ns4, nt8}, ComplexNumbers{{-1., 0.}}); }
