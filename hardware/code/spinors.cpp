...
void hardware::code::Spinors::fill_kernels()
{
    ...
    scalar_product_real_reduction = createKernel("scalar_product_real_reduction")
    ...
    if (kernelParameters->getUseEo()) {
        ...
        saxpy_eoprec_real_vec = createKernel("saxpy_eoprec_real_vec")
                                << basic_fermion_code << "spinorfield_eo_saxpy.cl";
        saxpy_arg_eoprec      = createKernel("saxpy_arg_eoprec") << basic_fermion_code << "spinorfield_eo_saxpy.cl";
        saxpy_eoprec_real_arg = createKernel("saxpy_eoprec_real_arg")
                                << basic_fermion_code << "spinorfield_eo_saxpy_real_arg.cl";
        saxpby_eoprec_cplx_arg = createKernel("saxpby_eoprec_cplx_arg")
                                 << basic_fermion_code << "spinorfield_eo_saxpby_cplx_arg.cl";
        saxpby_eoprec_real_vec = createKernel("saxpby_eoprec_real_vec")
                                 << basic_fermion_code << "spinorfield_eo_saxpby_real_vec.cl";
        sax_eoprec          = createKernel("sax_eoprec") << basic_fermion_code << "spinorfield_eo_sax.cl";
        sax_real_vec_eoprec = createKernel("sax_real_vec_eoprec")
                              << basic_fermion_code << "spinorfield_eo_sax_real_vec.cl";
        ...
        scalar_product_real_part_eoprec = createKernel("scalar_product_real_part_eoprec")
                                          << basic_fermion_code << "spinorfield_eo_scalar_product_real.cl";
    ...
    scalar_product_real_part = createKernel("scalar_product_real_part")
                               << basic_fermion_code << "spinorfield_scalar_product_real.cl";
...
void hardware::code::Spinors::get_work_sizes(const cl_kernel kernel, size_t* ls, size_t* gs, cl_uint* num_groups) const
{
    ...
    if (kernel == scalar_product_eoprec || kernel == scalar_product_real_part_eoprec || kernel == scalar_product ||
        kernel == scalar_product_real_part || kernel == global_squarenorm || kernel == global_squarenorm_eoprec) {
        if (*ls > 64) {
            *ls         = 64;
            *num_groups = (*gs) / (*ls);
        }
...
void hardware::code::Spinors::saxpy_device(const hardware::buffers::Plain<spinor>* x,
                                           const hardware::buffers::Plain<spinor>* y, const hmc_float alpha,
                                           const hardware::buffers::Plain<spinor>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors::saxpby_device(const hardware::buffers::Plain<spinor>* x,
                                            const hardware::buffers::Plain<spinor>* y, const hmc_complex alpha,
                                            const hmc_complex beta, const hardware::buffers::Plain<spinor>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors::saxpby_device(const hardware::buffers::Plain<spinor>* x,
                                            ...
                                            const int index_beta, const hardware::buffers::Plain<spinor>* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors::saxpy_eoprec_device(const hardware::buffers::Spinor* x,
                                                  const hardware::buffers::Spinor* y,
                                                  const hardware::buffers::Plain<hmc_float>* alpha,
                                                  const int index_alpha, const hardware::buffers::Spinor* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors::saxpy_eoprec_device(const hardware::buffers::Spinor* x,
                                                  const hardware::buffers::Spinor* y, const hmc_float alpha,
                                                  const hardware::buffers::Spinor* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
...
void hardware::code::Spinors::saxpby_eoprec_device(const hardware::buffers::Spinor* x,
                                                   const hardware::buffers::Spinor* y, const hmc_complex alpha,
                                                   const hmc_complex beta, const hardware::buffers::Spinor* out) const
{
    // query work-sizes for kernel
    size_t ls2, gs2;
    cl_uint num_groups;
...
void hardware::code::Spinors::set_float_to_scalar_product_real_device(
    const hardware::buffers::Plain<spinor>* a, const hardware::buffers::Plain<spinor>* b,
...
void hardware::code::Spinors::set_float_to_scalar_product_real_eoprec_device(
    const hardware::buffers::Spinor* a, const hardware::buffers::Spinor* b,
    const hardware::buffers::Plain<hmc_float>* out) const
{
    // query work-sizes for kernel
