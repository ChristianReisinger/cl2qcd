...
void hardware::code::Spinors::fill_kernels()
{
	...
	scalar_product_real_reduction = createKernel("scalar_product_real_reduction") << fundamental_sources << "types.hpp" << "operations_complex.hpp" << "spinorfield_scalar_product_reduction.cl";
