...
namespace physics {
    namespace lattices {
        ...
        void
        scalar_product_real_part(const Scalar<hmc_float>* res, const Spinorfield_eo& left, const Spinorfield_eo& right);
        ...
        void saxpy(const Spinorfield_eo* out, const Scalar<hmc_float>& alpha, const Spinorfield_eo& x,
                   const Spinorfield_eo& y);
        void saxpy(const Spinorfield_eo* out, const Vector<hmc_float>& alpha, const int index_alpha,
        ...
        template<>
        size_t
        get_flops<physics::lattices::Spinorfield_eo, hmc_complex, physics::lattices::saxpy>(const hardware::System&);
        template<>
        size_t
        get_flops<physics::lattices::Spinorfield_eo, hmc_float, physics::lattices::saxpy>(const hardware::System&);
         ...
         * out = alpha * x + beta * y
         */
        void saxpby(const Spinorfield_eo* out, const hmc_complex alpha, const Spinorfield_eo& x, const hmc_complex beta,
                    const Spinorfield_eo& y);
        void saxpby(const Spinorfield_eo* out, const Vector<hmc_float>& alpha, const int index_alpha,
        ...
        void
        sax(const Spinorfield_eo* out, const Vector<hmc_float>& alpha, const int index_alpha, const Spinorfield_eo& x);
         ...
         */
        void
        sax_vec_and_squarenorm(const Vector<hmc_float>* res, const Vector<hmc_float>& alpha, const Spinorfield_eo& x);
