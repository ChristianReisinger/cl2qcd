...
physics::lattices::wilson::Rooted_Spinorfield::Rooted_Spinorfield(
    const hardware::System& system, const RootedSpinorfieldParametersInterface& rootedSpinorfieldParametersInterface)
    : rationalCoefficients(
          std::max(rootedSpinorfieldParametersInterface.getMetropolisRationalApproximationOrder(),
...
void physics::lattices::wilson::Rooted_Spinorfield::Rescale_Coefficients(
...
const std::unique_ptr<physics::lattices::Spinorfield>& physics::lattices::wilson::Rooted_Spinorfield::
operator[](unsigned int index) const
{
    return pseudofermions[index];
}

std::vector<std::unique_ptr<physics::lattices::Spinorfield>>::iterator
physics::lattices::wilson::Rooted_Spinorfield::begin()
{
    return pseudofermions.begin();
}

std::vector<std::unique_ptr<physics::lattices::Spinorfield>>::const_iterator
physics::lattices::wilson::Rooted_Spinorfield::begin() const
{
    return pseudofermions.begin();
}

std::vector<std::unique_ptr<physics::lattices::Spinorfield>>::iterator
physics::lattices::wilson::Rooted_Spinorfield::end()
{
    return pseudofermions.end();
}

std::vector<std::unique_ptr<physics::lattices::Spinorfield>>::const_iterator
physics::lattices::wilson::Rooted_Spinorfield::end() const
{
    return pseudofermions.end();
}
