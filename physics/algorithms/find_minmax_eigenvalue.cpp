...
static hmc_float find_min_knowing_max(const hmc_float max, const physics::fermionmatrix::Fermionmatrix& A,
...
static hmc_float find_min_knowing_max(const hmc_float max, const physics::fermionmatrix::Fermionmatrix_eo& A,
                                      const physics::lattices::Gaugefield& gf, const hardware::System& system,
                                      physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                                      const physics::AdditionalParameters& additionalParameters);
static hmc_float find_min_knowing_max(const hmc_float max, const physics::fermionmatrix::Fermionmatrix_stagg_eo& A,
                                      ...
                                      physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                                      const physics::AdditionalParameters& additionalParameters);
template<class FERMIONMATRIX, class SPINORFIELD, class BASETYPE>
static hmc_float
find_min_knowing_max(const hmc_float max, const FERMIONMATRIX& A, const physics::lattices::Gaugefield& gf,
                     const hardware::System& system, physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                     const physics::AdditionalParameters& additionalParameters);

template<class FERMIONMATRIX, class SPINORFIELD, class BASETYPE>
hmc_float find_max_eigenvalue(const FERMIONMATRIX& A, const physics::lattices::Gaugefield& gf,
                                                   ...
                                                   const physics::AdditionalParameters& additionalParameters)
{
    ...
    return ::find_max_eigenvalue<Fermionmatrix_stagg_eo, Staggeredfield_eo, su3vec>(A, gf, system, interfacesHandler,
                                                                                    prec, additionalParameters);
}

hmc_float physics::algorithms::find_max_eigenvalue(const physics::fermionmatrix::Fermionmatrix& A,
                                                   const physics::lattices::Gaugefield& gf,
                                                   const hardware::System& system,
                                                   physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                                                   const physics::AdditionalParameters& additionalParameters)
{
    ...
    return ::find_max_eigenvalue<Fermionmatrix, Spinorfield, spinor>(A, gf, system, interfacesHandler, prec,
                                                                     additionalParameters);
}

hmc_float physics::algorithms::find_max_eigenvalue(const physics::fermionmatrix::Fermionmatrix_eo& A,
                                                   const physics::lattices::Gaugefield& gf,
                                                   const hardware::System& system,
                                                   physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                                                   const physics::AdditionalParameters& additionalParameters)
{
    ...
    return ::find_max_eigenvalue<Fermionmatrix_eo, Spinorfield_eo, spinor>(A, gf, system, interfacesHandler, prec,
                                                                           additionalParameters);
}

hmc_float physics::algorithms::find_min_eigenvalue(const physics::fermionmatrix::Fermionmatrix& A,
                                                   const physics::lattices::Gaugefield& gf,
                                                   const hardware::System& system,
                                                   physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                                                   const physics::AdditionalParameters& additionalParameters)
...
hmc_float physics::algorithms::find_min_eigenvalue(const physics::fermionmatrix::Fermionmatrix_eo& A,
                                                   const physics::lattices::Gaugefield& gf,
                                                   const hardware::System& system,
                                                   physics::InterfacesHandler& interfacesHandler, hmc_float prec,
                                                   const physics::AdditionalParameters& additionalParameters)
                                      ...
                                      const physics::AdditionalParameters& additionalParameters)
{
    ...
    return ::find_min_knowing_max<Fermionmatrix, Spinorfield, spinor>(max, A, gf, system, interfacesHandler, prec,
                                                                      additionalParameters);
}
                                      ...
                                      const physics::AdditionalParameters& additionalParameters)
{
    ...
    return ::find_min_knowing_max<Fermionmatrix_eo, Spinorfield_eo, spinor>(max, A, gf, system, interfacesHandler, prec,
                                                                            additionalParameters);
}
                                      ...
                                      const physics::AdditionalParameters& additionalParameters)
{
    ...
    return ::find_min_knowing_max<Fermionmatrix_stagg_eo, Staggeredfield_eo, su3vec>(max, A, gf, system,
                                                                                     interfacesHandler, prec,
                                                                                     additionalParameters);
}
