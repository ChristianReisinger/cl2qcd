...
{
    {
        ...
        const char* _params[] = {"foo", "--nTime=16", "--nDevices=1"};
    ...
    {
        using namespace physics::lattices;
        const char* _params[] = {"foo", "--nTime=4", "--nDevices=1"};
        meta::Inputparameters params(3, _params);
        physics::InterfacesHandlerImplementation interfacesHandler{params};
        hardware::HardwareParametersImplementation hP(&params);
        hardware::code::OpenClKernelParametersImplementation kP(params);
...

    {
        ...
        physics::algorithms::calc_fermion_forces(&gm, gf, sf1, system, interfacesHandler,
                                                 interfacesHandler
                                                     .getAdditionalParameters<physics::lattices::Spinorfield>());
...
BOOST_AUTO_TEST_CASE(fermion_force_shifted)
{
    ...
    Rational_Approximation approx(25, 99999999, 100000000, 1.e-5,
                                  1);  // x = 99999999 and y = 100000000 are chosen such that N_f=2 is approximated

    physics::fermionmatrix::QplusQminus Qpm(system,
    ...
    find_maxmin_eigenvalue(maxEigen, minEigen, Qpm, gf, system, interfacesHandler,
                           parametersInterface.getFindMinMaxPrec(),
                           interfacesHandler.getAdditionalParameters<wilson::Rooted_Spinorfield>());

    wilson::Rooted_Spinorfield sf1(system,
    ...
    gm.zero();
    physics::algorithms::calc_fermion_forces(&gm, gf, sf1, system, interfacesHandler,
                                             interfacesHandler.getAdditionalParameters<
                                                 physics::lattices::wilson::Rooted_Spinorfield>());
...
BOOST_AUTO_TEST_CASE(fermion_force_eo_shifted)
{
    ...
    physics::fermionmatrix::QplusQminus_eo Qpm(system, interfacesHandler
                                                           .getInterface<physics::fermionmatrix::QplusQminus_eo>());
    hmc_float minEigen, maxEigen;
    ...
    wilson::Rooted_Spinorfield_eo
        sf1(system, interfacesHandler.getInterface<physics::lattices::wilson::Rooted_Spinorfield_eo>(), approx);
    ...
    physics::algorithms::calc_fermion_forces(&gm, gf, sf1, system, interfacesHandler,
                                             interfacesHandler.getAdditionalParameters<
                                                 physics::lattices::wilson::Rooted_Spinorfield_eo>());
    // TODO: Result still has to be checked by true analytic test
...
{
    {
        ...
        physics::algorithms::calc_fermion_forces(&gm, gf, src, system, interfacesHandler,
                                                 interfacesHandler.getAdditionalParameters<Spinorfield_eo>());
...
BOOST_AUTO_TEST_CASE(calc_detratio_forces_eo)
{
    {
        using namespace physics::lattices;
        const char* _params[] = {"foo", "--nTime=4", "--useMP=true", "--kappaMP=.25", "--nDevices=1"};
