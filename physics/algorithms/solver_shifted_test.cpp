...
BOOST_AUTO_TEST_CASE(cgm_wilson_1)
{
    ...
    meta::Inputparameters* params;
    const char* _params[] = {"foo", "--nTime=4", "--fermionAction=wilson", "--kappa=0.125", "--nDevices=1"};
    params                = new meta::Inputparameters(5, _params);
    ...
    hmc_float pol[5] = {0.0002065381736724, 0.00302707751065980, 0.0200732678058145, 0.12517586269872370,
                        1.0029328743375700};
    std::vector<hmc_float> sigma(pol, pol + sizeof(pol) / sizeof(hmc_float));
    physics::fermionmatrix::QplusQminus matrix(system,
...
BOOST_AUTO_TEST_CASE(cgm_wilson_eo_1)
{
    ...
    hmc_float pol[5] = {0.0002065381736724, 0.00302707751065980, 0.0200732678058145, 0.12517586269872370,
                        1.0029328743375700};
    std::vector<hmc_float> sigma(pol, pol + sizeof(pol) / sizeof(hmc_float));
    physics::fermionmatrix::QplusQminus_eo matrix(system, interfacesHandler
