...
int physics::algorithms::solvers::cg_m(std::vector<std::shared_ptr<physics::lattices::Spinorfield_eo>> x,
                                       ...
                                       const physics::AdditionalParameters& additionalParameters)
{
    physics::algorithms::solvers::SolverShifted<physics::lattices::Spinorfield_eo,
                                                physics::fermionmatrix::Fermionmatrix_eo>
        solverShifted(x, A, gf, sigma, b, system, interfacesHandler, prec, additionalParameters);
    x = solverShifted.solve();
    return solverShifted.getNumberOfIterationsDone();
}
...
void physics::algorithms::solvers::SolverShifted<FERMIONFIELD, FERMIONMATRIX>::makePerformanceReport()
{
    ...
    if (logger.beInfo()) {
        ...
        //                                                        FERMIONFIELD, hmc_float,
        //                                                        physics::lattices::scalar_product_real_part>(system) +
        //                                                3 +
        //                                                2 * physics::lattices::get_flops<FERMIONFIELD, hmc_float,
        //                                                                                 physics::lattices::saxpy>(system)
        //                                                                                 +
        //                                                physics::lattices::get_flops_update_cgm("alpha",
        //                                                numberOfEquations,
        //                                                                                        system) +
        //                                                physics::lattices::get_flops_update_cgm("beta",
        //                                                numberOfEquations,
        //                                                                                        system) +
        //                                                physics::lattices::get_flops_update_cgm("zeta",
        //                                                numberOfEquations,
        //                                                                                        system);
        //        cl_ulong flops_per_iter_only_inner_loop = physics::lattices::get_flops<FERMIONFIELD, hmc_float,
        //                                                                               physics::lattices::saxpy>(system)
        //                                                                               +
        //                                                  physics::lattices::get_flops<FERMIONFIELD, hmc_float,
        //                                                                               physics::lattices::saxpby>(system)
        //                                                                               +
        //                                                  physics::lattices::get_flops<FERMIONFIELD, hmc_float,
        //                                                                               physics::lattices::sax>(system)
        //                                                                               +
        //                                                  physics::lattices::get_flops<FERMIONFIELD,
...
void physics::algorithms::solvers::SolverShifted<FERMIONFIELD, FERMIONMATRIX>::debugLogSquarenormSetOfFields(
    const std::string& message, const std::vector<std::shared_ptr<FERMIONFIELD>> setOfFields, const int reportNumber)
{
    if (logger.beDebug()) {
