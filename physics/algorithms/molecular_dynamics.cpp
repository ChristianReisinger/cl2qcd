 ...
 */
template<class FERMIONMATRIX, class ROOTED_SPINORFIELD, class SPINORFIELD>
static void md_update_spinorfield(const ROOTED_SPINORFIELD* out, const physics::lattices::Gaugefield& gf,
                                  ...
                                  const physics::AdditionalParameters& additionalParameters)
{
    ...
    const unsigned int numberOfPseudofermions = interfacesHandler.getInterface<ROOTED_SPINORFIELD>()
                                                ...
                                                const physics::AdditionalParameters& additionalParameters)
{
    ...
    ::md_update_spinorfield<MdagM_eo, Rooted_Staggeredfield_eo, Staggeredfield_eo>(out, gf, orig, system,
                                                                                   interfacesHandler,
                                                                                   additionalParameters);
}

void physics::algorithms::md_update_spinorfield(const physics::lattices::wilson::Rooted_Spinorfield* out,
                                                const physics::lattices::Gaugefield& gf,
                                                const physics::lattices::wilson::Rooted_Spinorfield& orig,
                                                const hardware::System& system,
                                                physics::InterfacesHandler& interfacesHandler,
                                                const physics::AdditionalParameters& additionalParameters)
{
    ...
    ::md_update_spinorfield<QplusQminus, Rooted_Spinorfield, Spinorfield>(out, gf, orig, system, interfacesHandler,
                                                                          additionalParameters);
}

void physics::algorithms::md_update_spinorfield(const physics::lattices::wilson::Rooted_Spinorfield_eo* out,
                                                const physics::lattices::Gaugefield& gf,
                                                const physics::lattices::wilson::Rooted_Spinorfield_eo& orig,
                                                const hardware::System& system,
                                                physics::InterfacesHandler& interfacesHandler,
                                                const physics::AdditionalParameters& additionalParameters)
{
    ...
    ::md_update_spinorfield<QplusQminus_eo, Rooted_Spinorfield_eo, Spinorfield_eo>(out, gf, orig, system,
                                                                                   interfacesHandler,
                                                                                   additionalParameters);
}
