...
namespace physics {
    ...
    template<>
    inline const typename InterfaceType<physics::fermionmatrix::Aee_AND_gamma5_eo>::value&
    InterfacesHandler::getInterface<physics::fermionmatrix::Aee_AND_gamma5_eo>()
    {
        return getFermionEoParametersInterface();
    }
    template<>
