...
namespace physics {
    ...
    class InterfacesHandler {
      ...
      private:
        ...
        virtual const physics::lattices::RootedSpinorfieldParametersInterface&
        getRootedSpinorfieldParametersInterface()                                                                = 0;
        virtual const physics::lattices::SpinorfieldEoParametersInterface& getSpinorfieldEoParametersInterface() = 0;
        virtual const physics::lattices::RootedSpinorfieldEoParametersInterface&
        getRootedSpinorfieldEoParametersInterface() = 0;
    ...
    template<>
    inline const typename InterfaceType<physics::lattices::wilson::Rooted_Spinorfield>::value&
    ...
    template<>
    inline const typename InterfaceType<physics::lattices::wilson::Rooted_Spinorfield_eo>::value&
    InterfacesHandler::getInterface<physics::lattices::wilson::Rooted_Spinorfield_eo>()
    {
    ...
    template<>
    inline const physics::AdditionalParameters&
    InterfacesHandler::getAdditionalParameters<physics::lattices::wilson::Rooted_Spinorfield>(
    ...
    template<>
    inline const physics::AdditionalParameters&
    InterfacesHandler::getAdditionalParameters<physics::lattices::wilson::Rooted_Spinorfield_eo>(
        bool withMassPreconditioning)
    {
        return getWilsonAdditionalParameters(withMassPreconditioning);
    }
