           ...
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    ...
    if (actAsGivenFermact == NULL)
        actionToBeUsed = fermionmatrixParametersInterface.getFermionicActionType();
    else if (*actAsGivenFermact == common::action::wilson)
        actionToBeUsed = *actAsGivenFermact;
    else
        throw Invalid_Parameters("It is only possible to use wilson type fermion matrices with clover action",
                                 "expected *actAsGivenFermact == common::action::wilson", *actAsGivenFermact);
    ...
    switch (actionToBeUsed) {
        ...
        case common::action::clover:  // explicit scope to be able to declare variable in it, initializing it at the
                                      // same time
        {
        ...
        default:
            throw Invalid_Parameters("Unkown fermion action!", "wilson or twistedmass or clover",
                                     fermionmatrixParametersInterface.getFermionicActionType());
    }
}
           ...
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    ...
    switch (actionToBeUsed) {
                                      ...
                                      // same time
        {
            ...
            sax(out, {c_0_hat, 0.}, *out);
            break;
            // throw Invalid_Parameters("Using Aee_minus with clover action!", "wilson or twistedmass",
            // fermionmatrixParametersInterface.getFermionicActionType());
        }
        default:
            throw Invalid_Parameters("Unkown fermion action!", "wilson or twistedmass",
           ...
           const physics::lattices::Spinorfield_eo& in, const physics::AdditionalParameters& additionalParameters) const
{
    ...
    switch (actionToBeUsed) {
        ...
        case common::action::clover: {
            ...
            sax(out, {c_0_hat, 0.}, *out);
            break;
            // throw Invalid_Parameters("Using Aee_minus_AND_gamma5_eo with clover action!", "wilson or twistedmass",
            // fermionmatrixParametersInterface.getFermionicActionType());
        }
        default:
            throw Invalid_Parameters("Unkown fermion action!", "wilson or twistedmass",
