...
namespace physics {
    ...
    namespace fermionmatrix {
        ...
        void clover_eo(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
                       const physics::lattices::Spinorfield_eo& in, int evenodd, hmc_float kappa, hmc_float csw);
        void clover_eo_inverse(const physics::lattices::Spinorfield_eo* out, const physics::lattices::Gaugefield& gf,
                               const physics::lattices::Spinorfield_eo& in, int evenodd, hmc_float kappa,
                               hmc_float csw);
        ...
        class Aee final : public Fermionmatrix_eo {
          public:
            Aee(const hardware::System& system, const FermionEoParametersInterface& fermionEoParametersInterface,
                const common::action* actAsGivenFermact = NULL)
                ...
                , actAsGivenFermact(actAsGivenFermact){};
