...
{
    {
        ...
        if (clover) {
            const physics::AdditionalParameters&
                additionalParametersClover = interfacesHandler.getAdditionalParameters<Spinorfield_eo>();
            ...
            const physics::AdditionalParameters&
                additionalParametersWilson = interfacesHandler.getAdditionalParameters<Spinorfield_eo>();
