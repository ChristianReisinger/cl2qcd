...
{
    {
        ...
        matrix2(&out, gf, sf2);
        BOOST_CHECK_CLOSE(squarenorm(out), refs[1], 1.e-8);
        BOOST_REQUIRE_THROW(matrix1(&out, gf, sf1, interfacesHandler.getAdditionalParameters<Staggeredfield_eo>()),
                            Print_Error_Message);
        BOOST_REQUIRE_THROW(matrix2(&out, gf, sf2, interfacesHandler.getAdditionalParameters<Staggeredfield_eo>()),
                            Print_Error_Message);
    }
