...
namespace physics {
    namespace lattices {
        ...
        class RootedSpinorfieldParametersImplementation final : public RootedSpinorfieldParametersInterface,
                                                                private SpinorfieldParametersImplementation {
          public:
            ...
            unsigned getNt() const override { return SpinorfieldParametersImplementation::getNt(); }
            unsigned getNs() const override { return SpinorfieldParametersImplementation::getNs(); }
            unsigned getNumberOfElements() const override
            {
            ...
            unsigned getNumberOfPseudofermions() const override
            {
                ...
                if (num_pseudofermions > 1)
                    throw Print_Error_Message("Multiple pseudofermions not implemented for wilson fermions!", __FILE__,
                                              __LINE__);
                else
        ...
        class RootedSpinorfieldEoParametersImplementation final : public RootedSpinorfieldEoParametersInterface,
                                                                  private SpinorfieldEoParametersImplementation {
          public:
