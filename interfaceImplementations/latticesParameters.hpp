    ...
    namespace lattices {
        ...
        class GaugefieldParametersImplementation : public GaugefieldParametersInterface {
          public:
            ...
            virtual unsigned getNumberOfElementsMatrix6x6Field() const override { return meta::get_vol4d(*parameters); }
            virtual double getKappa() const override { return parameters->get_kappa(); }
            virtual double getCsw() const override { return parameters->get_csw(); }
